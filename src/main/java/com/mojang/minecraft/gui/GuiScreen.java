...
public class GuiScreen extends Screen {
   ...
   public void render(int var1, int var2) {
      for (Button button : this.buttons) {
         if (button.visible) {
            FontRenderer var8 = game.fontRenderer;
            GL11.glBindTexture(3553, game.textureManager.load("/gui/gui.png"));
   ...
   public final void open(Game game, int windowWidth, int windowHeight) {
      this.game = game;
   ...
   public final void mouseEvent() {
      if(Mouse.getEventButtonState()) {
         int var1 = Mouse.getEventX() * this.width / this.game.width;
         int var2 = this.height - Mouse.getEventY() * this.height / this.game.height - 1;
