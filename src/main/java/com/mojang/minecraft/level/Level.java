...
public class Level implements Serializable {
	...
	public List<Entity> findEntities(Entity e, AABB var2) {
		return blockMap.getEntities(e, var2);
	}
		...
		for (int var9 = var5 - 6; var9 <= var5 + 6; ++var9) {
			for (int var10 = var6 - 6; var10 <= var6 + 6; ++var10) {
				if (this.isInBounds(var9, var14, var10) && !this.isSolidTile(var9, var14, var10)) {
					...
					float var12;
					float var13;
					for (var13 = (float) (Math.atan2(var12 = (float) var10 + 0.5F - var3, var11) - (double) (var4 * 3.1415927F / 180.0F) + 1.5707963705062866D); var13 < -3.1415927F; var13 += 6.2831855F) {
                    }
	...
	public void explode(Entity e, float var2, float var3, float var4, float var5) {
		...
		List var18 = this.blockMap.getEntities(e, (float) var6, (float) var8, (float) var10, (float) var7, (float) var9, (float) var11);

		for (var13 = 0; var13 < var18.size(); ++var13) {
			Entity var20;
			if ((var15 = (var20 = (Entity) var18.get(var13)).distanceTo(var2, var3, var4) / var5) <= 1.0F) {
				var16 = 1.0F - var15;
				var20.hurt(e, (int) (var16 * 15.0F + 1.0F));
			}
		}
